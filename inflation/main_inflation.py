...
def hello():
    ...
    # Unnamed: 0
    col_interest ='Percentage Change from Corresponding Quarter of Previous Year ;  All groups CPI ;  Australia ;'
    data_col = 'Date from'
    filename = 'TABLES 1 and 2. CPI All Groups, Index Numbers and Percentage Changes_640101'
    data_pd = pd.read_excel(f'../data/raw/indirect/{filename}.xlsx', header=0, sheet_name='Data1')
    keep_cols = [
        'Unnamed: 0',
        col_interest
