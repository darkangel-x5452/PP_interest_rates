...
def hello():
    # 'Unemployment rate ;  Persons ;.1' # seasonal
    # 'Unemployed total ;  Persons ;.2' # original
    # Unnamed: 0
    filename = 'employment_data_6202001'
    data_pd = pd.read_excel('../data/raw/indirect/employment_data_6202001.xlsx', header=0, sheet_name='Data1')
    keep_cols = [
        'Unnamed: 0',
    ...
    data_pd['Unemployment rate ;  Persons ;.1'] = data_pd['Unemployment rate ;  Persons ;.1'].astype(float)
    ...
    # data_pd = data_pd.set_index('Unnamed: 0', drop=True)
    # data_pd.plot()
    # plt.show()
    print('bye')
